...
export const defaults = Object.freeze({judge:false,context:false,prune:false,routing:false,instant_compaction:false,early_compaction:false,compaction_audit:false,tool_gate:false,browser_selector:false,computer_selector:false,ios_selector:false,decision_metrics:false,session_reader:false,tool_routing_gateway:false,control_loop:false,subagent_contract:false,verification_gate:false,verification_assessment:false,verification_enforcement:false,decision_enforcement:false,data_collection:false,collection_enforcement:false,visual_review:false,visual_enforcement:false});
