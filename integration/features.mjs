...
export const defaults = Object.freeze({judge:false,context:false,prune:false,routing:false,instant_compaction:false,early_compaction:false,compaction_audit:false,tool_gate:false,browser_selector:false,computer_selector:false,ios_selector:false,decision_metrics:false,tool_routing_gateway:false,control_loop:false,subagent_contract:false,session_reader:false,verification_gate:false,verification_assessment:false});
